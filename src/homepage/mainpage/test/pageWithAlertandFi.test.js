...
import pageWithAlertandField from "../pageWithAlertandField";
import {render,screen,cleanup,fireEvent} from'@testing-library/react';
import {userEvent} from'@testing-library/user-event';
describe('pageWithAlertandField',()=>{ it('should render the same text in to title prop',async() => {
      render(<pageWithAlertandField/>);
